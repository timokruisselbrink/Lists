...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(router, afAuth) {
        var _this = this;
        this.router = router;
        this.afAuth = afAuth;
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(router, afAuth) {
        this.router = router;
        this.afAuth = afAuth;
        this.isActive = false;
        this.showMenu = '';
...
module.exports = "<div class=\"row\">\n    <div class=\"col-xl-12\">\n        <h2 class=\"page-header\">\n            {{heading}}\n        </h2>\n        <ol class=\"breadcrumb\">\n            <li class=\"breadcrumb-item\">\n                <i class=\"fa fa-dashboard\"></i> <a href=\"Javascript:void(0)\" [routerLink]=\"['/blank-page']\">Dashboard</a>\n            </li>\n            <li class=\"breadcrumb-item active\"><i class=\"fa {{icon}}\"></i> {{heading}}</li>\n        </ol>\n    </div>\n</div>"
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyBPQ5QPW16pYe-prKJuvpQcrih8EIgT-eM",
        authDomain: "lists-82c26.firebaseapp.com",
        databaseURL: "https://lists-82c26.firebaseio.com",
        projectId: "lists-82c26",
        storageBucket: "lists-82c26.appspot.com",
        messagingSenderId: "527536207072"
    }
};
