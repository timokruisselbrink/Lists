...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(router, afAuth, db) {
        this.router = router;
        this.afAuth = afAuth;
        this.isActive = false;
        this.showMenu = '';
